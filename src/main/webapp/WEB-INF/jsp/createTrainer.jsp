    ...
    <div class="row container-fluid">
        ...
        <div class="col-4" id="pad-right-0-left-25">
            <form action="doCreate" method="post">
                <label for="firstName">Name (Must be 3 letters or more): </label>
                <input type="text" id="firstName" name="firstName" placeholder="Name" required>
                <label for="lastName">Surname (Must be 3 letters or more): </label>
                <input type="text" id="lastName" name="lastName" placeholder="Surname" required>
                <label for="subject">Subject (Optional): </label>
                <input type="text" id="subject" name="subject" placeholder="Subject">
                <input class="button" id="update-button" type="submit" value="Create Trainer">
            </form>
        </div>
